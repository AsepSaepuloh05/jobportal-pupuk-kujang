...
export default function EditLowonganPage() {
    ...
    useEffect(() => {
        const getLowongan = async () => {
            try {
                ...
                setTanggungJawab(data.tanggungJawab || "");
                setGajiMin(
                    data.gajiMin !== null && data.gajiMin !== undefined
                        ? String(data.gajiMin)
                        : ""
                );
                setGajiMax(
                    data.gajiMax !== null && data.gajiMax !== undefined
                        ? String(data.gajiMax)
                        : ""
                );
                ...
                console.error("GET LOWONGAN ERROR:", err);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error(data.message || "Gagal memperbarui lowongan");
            }

            router.push("/hr/kelolalowongan");
        } catch (err) {
            console.error("UPDATE LOWONGAN ERROR:", err);
            ...
            <div className="mx-auto w-full max-w-[1600px] px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div className="mb-6">
                    ...
                    <p className="mt-0.5 text-sm text-slate-500">
                        Lowongan yang kamu coba edit mungkin sudah dihapus.
                    </p>
                </div>
                    ...
                    <div className="space-y-5 p-6 sm:p-8">
                        ...
                        <div>
                            ...
                            <textarea
                                id="persyaratan"
                                rows={4}
                                placeholder="Satu syarat per baris"
                                value={persyaratan}
