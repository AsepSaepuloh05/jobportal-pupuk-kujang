...
function EducationItem({
  ...
  const institutionInitial =
    item.institusi?.charAt(0)?.toUpperCase() || "P";
  ...
  return (
    ...
    >
      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-teal-50 text-sm font-bold text-teal-600 ring-1 ring-teal-100">
        {institutionInitial}
      </div>
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-3">
          {hasIjazah ? (
            <div className="flex flex-col gap-2 rounded-xl border border-emerald-100 bg-emerald-50/50 p-3 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 gap-2">
                {item.ijazahPathFile && (
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-2 text-[11px] font-semibold text-slate-600 transition hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700"
                  >
    ...
    >
      <div className="space-y-5">
        ...
        <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4">
          ...
          {hasExistingIjazah && (
            <div className="mb-3 flex items-center gap-3 rounded-lg border border-emerald-100 bg-white p-3">
          ...
          {ijazahFile ? (
            <div className="flex items-center gap-3 rounded-lg border border-teal-100 bg-teal-50/60 p-3">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white text-teal-600 ring-1 ring-teal-100">
            ...
            <label className="flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-dashed border-slate-300 bg-white px-4 py-3 text-xs font-semibold text-slate-500 transition hover:border-teal-400 hover:bg-teal-50 hover:text-teal-600">
              <Upload className="h-4 w-4" />
              Pilih File Ijazah
